...
Echoe.new('blog_basic', '0.1.3') do |p|
  ...
  p.runtime_dependencies = ['will_paginate >=3.0.1', "paperclip >=2.3", "activeadmin", "acts-as-taggable-on ~>2.1.1", "omniauth ~>1.0.0", "omniauth-openid ~>1.0.0", "omniauth-github ~>1.0.0"]
end
